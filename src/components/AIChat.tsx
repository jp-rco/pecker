            ...
            >
              ...
              <div className={cn(
                ...
                {m.role === "user" ? (
                  ...
                  <ReactMarkdown
                    components={{
                      h1: ({node, ...props}) => <h1 className="text-xl font-bold mt-4 mb-2 text-natural-primary" {...props} />,
                      h2: ({node, ...props}) => <h2 className="text-lg font-bold mt-4 mb-2 text-natural-primary" {...props} />,
                      h3: ({node, ...props}) => <h3 className="text-base font-bold mt-3 mb-1 text-natural-primary" {...props} />,
                      p: ({node, ...props}) => <p className="mb-2 last:mb-0" {...props} />,
                      ul: ({node, ...props}) => <ul className="list-disc pl-5 mb-3 space-y-1" {...props} />,
                      ol: ({node, ...props}) => <ol className="list-decimal pl-5 mb-3 space-y-1" {...props} />,
                      li: ({node, ...props}) => <li className="pl-1" {...props} />,
                      strong: ({node, ...props}) => <strong className="font-semibold text-natural-primary" {...props} />,
                      em: ({node, ...props}) => <em className="italic opacity-90" {...props} />,
                      hr: ({node, ...props}) => <hr className="my-4 border-natural-border" {...props} />
                    }}
                  >
                    {m.content}
                  </ReactMarkdown>
